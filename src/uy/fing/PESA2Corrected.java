...
public class PESA2Corrected<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
    ...
    public PESA2Corrected(Problem<S> problem, int maxEvaluations, int populationSize, int archiveSize,
        ...
        setMaxPopulationSize(populationSize); //FALTABA ESTA SENTENCIA EN EL PESA2 ORIGINAL
